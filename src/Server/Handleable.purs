...
instance handleableDeleteRoute ::
  ...
  Handleable
    (Route "DELETE" path (Record route))
    (Record payload -> Aff handlerRes)
    basePath
    baseParams
    baseGuards
...
instance handleableOptionsRoute ::
  ...
  Handleable
    (Route "OPTIONS" path (Record route))
    (Record payload -> Aff handlerRes)
    basePath
    baseParams
    baseGuards
