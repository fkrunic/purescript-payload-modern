module Test.UnitTests.Server.Cookies where
...
tests =
  suite "Cookies" do
    suite "parseCookieHeader" do
      ...
      test "ignores escaping error and returns original value"
        $ Assert.equal
